...
Minimal-mistakes is a theme for Jekyll, the same that you have with themes for <a href="https://wordpress.com" target="_blank" rel="noopener">Wordpress</a>, minimal-mistakes is a flexible two column Jekyll theme that helps you writing blogs posts.
...
```html
<head>
  //the code snippet to show the popup form has to be placed here before this
  tag closes.
</head>
```
